@echo off
title BrightCare Admin Client - 3-Tier Demo
setlocal
...
echo Starting Admin GUI (connecting to %RMI_SERVER_IP%)...
java -Dbrightcare.rmi.host=%RMI_SERVER_IP% -Dbrightcare.ssl.enabled=false -cp "%CLASSES%" brigthcare_medical_centre.gui.admin.AdminLoginFrame
pause
